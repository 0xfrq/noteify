...
% Font: Courier untuk Source Code
\usepackage{courier}
...
\lstdefinestyle{pythonstyle}{
  ...
  framerule=0.8pt,
  basicstyle=\ttfamily\small, % Menggunakan Courier dari package courier
...
\fancyhead[R]{\small\textit{noteify -- Dasar-Dasar Pembentukan Citra}}
\fancyfoot[C]{\thepage}
...
\title{
  ...
  {\large Bab 2: Dasar-Dasar Pembentukan Citra}\\[0.8em]
  {\normalsize Materi ini membahas proses pembentukan citra mulai dari aspek fisik cahaya hingga representasi digitalnya.}
}
\author{}
\date{}
